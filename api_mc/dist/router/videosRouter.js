...
const videos = tsyringe_1.container.resolve(videosController_1.default);
videosRouter.route("/api/v1/videos/page/:qtd").get((req, res) => {
...
// galeriaRouter.ts (partial, as seen in the image)
require("reflect-metadata");
